    ...
    function listarTarj($id)
    {
        ...
        if ($filas != null) 
        {
            foreach ($filas as $fila) 
            {
                ...
                echo "<a href='index.php?pagina=tarjeta&cta=".$fila[5]."&ctait=".$fila[6]."'' alt='Cuenta=$fila[5]' title='Cuenta=$fila[5]'><table border=1 align='center' width='10%' style='background:#91c1ba;'>";
